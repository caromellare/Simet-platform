...
import { RefreshCw, AlertCircle, TrendingUp, MousePointer, DollarSign, Target } from 'lucide-react'
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="bg-bg-card border border-bg-border rounded-xl p-10 text-center">
          ...
          <p className="text-slate-600 text-sm mt-1">Esta marca no tuvo campañas de Meta Ads en el rango seleccionado</p>
        </div>
      ) : campaigns.length > 0 ? (
