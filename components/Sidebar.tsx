...
import {
  ...
  Megaphone, Zap, ChevronRight, Settings, CheckSquare, Sun, Moon
} from 'lucide-react'
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-60 bg-bg-card border-r border-bg-border flex flex-col z-50">
      ...
      <div className="px-3 pb-4 border-t border-bg-border pt-3 space-y-0.5">
        <button
          onClick={toggle}
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-slate-500 hover:text-slate-300 hover:bg-bg-elevated transition-all w-full"
        >
